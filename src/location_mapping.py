...
class mapping:
    ...
    def conditional_mapping(self,OED_location_file_value_mapped, AIR_location_file,logger):
        ...
        try:
            ...
            OED_location_file_value_mapped['LocDed4BI'] = np.where(AIR_location_file['DeductibleTypeCode'] == 'PL',1,None)

            OED_location_file_value_mapped['LocDedType2Other'] = np.where(AIR_location_file['DeductibleTypeCode'] == 'MP',AIR_location_file['Deductible1'], None)
            OED_location_file_value_mapped['LocDedType3Contents'] = np.where(AIR_location_file['DeductibleTypeCode'] == 'MP', 5, None)
            OED_location_file_value_mapped['LocDed4BI'] = np.where(AIR_location_file['DeductibleTypeCode'] == 'MP',2, None)
            ...
            OED_location_file_value_mapped['LocDed4BI'] = np.where(AIR_location_file['DeductibleTypeCode'] == 'ML', AIR_location_file['Deductible4'], None)
            ...
            OED_location_file_value_mapped['LocDed1Building'] = np.where(AIR_location_file['DeductibleTypeCode'] == 'C', AIR_location_file['Deductible1'], None)
            OED_location_file_value_mapped['LocDed2Other'] = np.where(AIR_location_file['DeductibleTypeCode'] == 'C', AIR_location_file['Deductible2'], None)
            OED_location_file_value_mapped['LocDed3Contents'] = np.where(AIR_location_file['DeductibleTypeCode'] == 'C', AIR_location_file['Deductible3'], None)
            OED_location_file_value_mapped['LocDed4BI'] = np.where(AIR_location_file['DeductibleTypeCode'] == 'C', AIR_location_file['Deductible4'], None)

            OED_location_file_value_mapped['LocDed5PD'] = np.where(AIR_location_file['DeductibleTypeCode'] == 'CB', AIR_location_file['Deductible1']+AIR_location_file['Deductible2']+AIR_location_file['Deductible3'], None)
            OED_location_file_value_mapped['LocDed5PD'] = np.where(AIR_location_file['DeductibleTypeCode'] == 'CT', AIR_location_file['Deductible1']+AIR_location_file['Deductible2']+AIR_location_file['Deductible3'], None)
            OED_location_file_value_mapped['LocDed4BI'] = np.where(AIR_location_file['DeductibleTypeCode'] == 'CT',AIR_location_file['Deductible4'], None)
            ...
            OED_location_file_value_mapped['LocDed6All'] = np.where(AIR_location_file['DeductibleTypeCode'] == 'FR', AIR_location_file['Deductible1']+AIR_location_file['Deductible2']+AIR_location_file['Deductible3']+AIR_location_file['Deductible4'], None)
            OED_location_file_value_mapped['LocDedCode6All'] = np.where(AIR_location_file['DeductibleTypeCode'] == 'FR',1,None)

            OED_location_file_value_mapped['LocDed5PD'] = np.where(AIR_location_file['DeductibleTypeCode'] == 'CT',AIR_location_file['Deductible1'], None)
            OED_location_file_value_mapped['LocDedType5PD'] = np.where(AIR_location_file['DeductibleTypeCode'] == 'CT',1, None)
            OED_location_file_value_mapped['LocDed4BI'] = np.where(AIR_location_file['DeductibleTypeCode'] == 'CT',AIR_location_file['Deductible4'], None)
